...
public class ImDrawList extends IDLBase {
    ...
    public int getFlags() {
        return getFlagsNATIVE((int) native_address);
    }
    ...
    */
    @org.teavm.jso.JSBody(params = {"addr"}, script = "var nativeObject = imgui.wrapPointer(addr, imgui.ImDrawList); return nativeObject.get_Flags();")
    private static native int getFlagsNATIVE(int addr);

    public ImDrawCmd getCmdBuffer(int index) {
        int pointer = getCmdBufferNATIVE((int) native_address, index);
    ...
    */
    @org.teavm.jso.JSBody(params = {"addr", "index"}, script = "var nativeObject = imgui.wrapPointer(addr, imgui.ImDrawList); var cmdBuffer = nativeObject.get_CmdBuffer(); var drawCmd = cmdBuffer.getData(index); return imgui.getPointer(drawCmd);")
    private static native int getCmdBufferNATIVE(int addr, int index);

    public int getCmdBufferSize() {
        return getCmdBufferSizeNATIVE((int) native_address);
    }
    ...
    */
    @org.teavm.jso.JSBody(params = {"addr"}, script = "var nativeObject = imgui.wrapPointer(addr, imgui.ImDrawList); return nativeObject.CmdBuffer.size();")
    private static native int getCmdBufferSizeNATIVE(int addr);

    public ByteBuffer getIdxBufferData() {
        int idxBufferSize = getIdxBufferSizeNATIVE((int) native_address);
        ...
        getIdxBufferDataNATIVE((int) native_address, (int) idxBuffer.native_address, idxBufferCapacity);
    ...
    */
    @org.teavm.jso.JSBody(params = {"addr", "bufferAddr", "bufferCapacity"}, script = "var nativeObject = imgui.wrapPointer(addr, imgui.ImDrawList); var charArray = imgui.wrapPointer(bufferAddr, imgui.IDLByteArray); var charArrayPtr = charArray.getPointer(); imgui.ImHelper.prototype.memcpyIdx(charArrayPtr, nativeObject, bufferCapacity);")
    private static native void getIdxBufferDataNATIVE(int addr, int bufferAddr, int bufferCapacity);
    ...
    */
    @org.teavm.jso.JSBody(params = {"addr"}, script = "var nativeObject = imgui.wrapPointer(addr, imgui.ImDrawList); return nativeObject.IdxBuffer.size();")
    private static native int getIdxBufferSizeNATIVE(int addr);

    public ByteBuffer getVtxBufferData() {
        int vtxBufferSize = getVtxBufferSizeNATIVE((int) native_address);
        ...
        getVtxBufferDataNATIVE((int) native_address, (int) vtxBuffer.native_address, vtxBufferCapacity);
    ...
    */
    @org.teavm.jso.JSBody(params = {"addr", "bufferAddr", "bufferCapacity"}, script = "var nativeObject = imgui.wrapPointer(addr, imgui.ImDrawList); var charArray = imgui.wrapPointer(bufferAddr, imgui.IDLByteArray); var charArrayPtr = charArray.getPointer(); imgui.ImHelper.prototype.memcpyVtx(charArrayPtr, nativeObject, bufferCapacity);")
    private static native void getVtxBufferDataNATIVE(int addr, int bufferAddr, int bufferCapacity);
    ...
    */
    @org.teavm.jso.JSBody(params = {"addr"}, script = "var nativeObject = imgui.wrapPointer(addr, imgui.ImDrawList); return nativeObject.VtxBuffer.size();")
    private static native int getVtxBufferSizeNATIVE(int addr);
