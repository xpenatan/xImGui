...
public class IDLIntArray extends IDLArray {
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = new imgui.IDLIntArray(size);
      return imgui.getPointer(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"size"}, script = "var jsObj = new imgui.IDLIntArray(size);return imgui.getPointer(jsObj);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = imgui.wrapPointer(this_addr, imgui.IDLIntArray);
      imgui.destroy(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLIntArray);imgui.destroy(jsObj);")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLIntArray);var returnedJSObj = jsObj.getValue(index);return returnedJSObj;")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index", "value"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLIntArray);jsObj.setValue(index, value);")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "src_addr", "srcOffset", "destOffset", "length"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLIntArray);jsObj.copy(src_addr, srcOffset, destOffset, length);")
