...
public class IDLStringView extends IDLBase {
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLStringView); var returnedJSObj = jsObj.data(); return returnedJSObj;")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = new imgui.IDLStringView(text);
      return imgui.getPointer(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"text"}, script = "var jsObj = new imgui.IDLStringView(text);return imgui.getPointer(jsObj);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = new imgui.IDLStringView(text, size);
      return imgui.getPointer(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"text", "size"}, script = "var jsObj = new imgui.IDLStringView(text, size);return imgui.getPointer(jsObj);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = imgui.wrapPointer(this_addr, imgui.IDLStringView);
      imgui.destroy(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLStringView);imgui.destroy(jsObj);")
    ...
    /*
      ...
      return returnedJSObj;
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLStringView);var returnedJSObj = jsObj.size();return returnedJSObj;")
    ...
    /*
      ...
      return returnedJSObj;
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLStringView);var returnedJSObj = jsObj.at(index);return returnedJSObj;")
