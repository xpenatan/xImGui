...
public class IDLLongArray extends IDLArrayBase {
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = new imgui.IDLLongArray(size);
      return imgui.getPointer(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"size"}, script = "var jsObj = new imgui.IDLLongArray(size);return imgui.getPointer(jsObj);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = imgui.wrapPointer(this_addr, imgui.IDLLongArray);
      imgui.destroy(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLLongArray);imgui.destroy(jsObj);")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLLongArray);var returnedJSObj = jsObj.getValue(index);return returnedJSObj;")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index", "value"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLLongArray);jsObj.setValue(index, value);")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "src_addr", "srcOffset", "destOffset", "length"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLLongArray);jsObj.copy(src_addr, srcOffset, destOffset, length);")
