...
public class IDLArrayBase extends IDLBase {
    ...
    /*
      [-TEAVM;-NATIVE]
            ...
            jsObj.resize(size);
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "size"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLArrayBase); jsObj.resize(size);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = imgui.wrapPointer(this_addr, imgui.IDLArrayBase);
      imgui.destroy(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLArrayBase);imgui.destroy(jsObj);")
    ...
    /*
      ...
      jsObj.clear();
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLArrayBase);jsObj.clear();")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLArrayBase);var returnedJSObj = jsObj.getSize();return returnedJSObj;")
    ...
    /*
      ...
      return returnedJSObj;
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLArrayBase);var returnedJSObj = jsObj.getPointer();return returnedJSObj;")
