...
public class IDLBool extends IDLBoolArray {
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = new imgui.IDLBool();
      return imgui.getPointer(jsObj);
    */
    @org.teavm.jso.JSBody(script = "var jsObj = new imgui.IDLBool();return imgui.getPointer(jsObj);")
    ...
    /*
      ...
      imgui.destroy(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = imgui.wrapPointer(this_addr, imgui.IDLBool);imgui.destroy(jsObj);")
