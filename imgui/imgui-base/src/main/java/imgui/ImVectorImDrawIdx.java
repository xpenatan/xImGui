...
public class ImVectorImDrawIdx extends IDLBase {
    ...
    public final static ImVectorImDrawIdx NULL = native_new();

    public static ImVectorImDrawIdx native_new() {
        return new ImVectorImDrawIdx((byte) 0, (char) 0);
    }

    private ImVectorImDrawIdx(byte v, char c) {
    }
    ...
    */
    ...
    /*[-TEAVM;-REPLACE]
        @org.teavm.jso.JSBody(params = {"this_addr", "size",  "outOffset", "bytes_addr"}, script = "" +
            "var jsObj = [MODULE].wrapPointer(this_addr, [MODULE].ImVectorImDrawIdx);" +
