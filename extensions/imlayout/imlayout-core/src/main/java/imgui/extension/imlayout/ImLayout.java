...
public class ImLayout extends IDLBase {
    ...
    */
    public static native void internal_native_DrawBoundingBox_2(long min_addr, long max_addr, int r, int g, int b, int a, boolean clipping);
    ...
    */
    public static native void internal_native_DrawBoundingBox_2(long min_addr, long max_addr, int r, int g, int b, int a);
    ...
    */
    public static native void internal_native_DrawBoundingBox_2(long min_addr, long max_addr, int r, int g, int b);
    ...
    */
    public static native void internal_native_DrawBoundingBox_3(long rect_addr, int r, int g, int b, int a, boolean clipping);
    ...
    */
    public static native void internal_native_DrawBoundingBox_3(long rect_addr, int r, int g, int b, int a);
    ...
    */
    public static native void internal_native_DrawBoundingBox_3(long rect_addr, int r, int g, int b);
    ...
    */
    public static native void internal_native_BeginLayout_1(int id, float sizeX, float sizeY, long options_addr);
    ...
    */
    public static native void internal_native_BeginLayout_2(String id, float sizeX, float sizeY, long options_addr);
    ...
    */
    public static native void internal_native_BeginAlign_1(int id, float sizeX, float sizeY, float alignX, float alignY, float offsetX, float offsetY, long options_addr);
    ...
    */
    public static native void internal_native_BeginAlign_2(String id, float sizeX, float sizeY, float alignX, float alignY, float offsetX, float offsetY, long options_addr);
    ...
    */
    public static native void internal_native_BeginCollapseLayout_2(String id, long isOpen_addr, String title, float sizeX, float sizeY);
    ...
    */
    public static native void internal_native_BeginCollapseLayout_2(String id, long isOpen_addr, String title, float sizeX, float sizeY, long option_addr);
    ...
    */
    public static native boolean internal_native_BeginCollapseLayoutEx_2(int id, String title, float sizeX, float sizeY, long option_addr);
    ...
    */
    public static native void internal_native_BeginCollapseLayoutEx_3(String id, long isOpen_addr, String title, float sizeX, float sizeY);
    ...
    */
    public static native void internal_native_BeginCollapseLayoutEx_3(String id, long isOpen_addr, String title, float sizeX, float sizeY, long option_addr);
